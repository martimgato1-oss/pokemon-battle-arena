...
async function main() {
  ...
  // Starter creatures
  const emberwing = await prisma.creatureSpecies.create({
    data: {
      name: 'Emberwing',
      description: 'A fierce fire creature with blazing wings',
      element: Element.FIRE,
      ...
      evolvesTo: 'Infernix',
      evolutionLevel: 16,
      spriteUrl: '/sprites/emberwing.png',
      iconUrl: '/icons/emberwing.png',
      isStarter: true,
      learnset: [
